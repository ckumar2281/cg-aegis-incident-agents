...
> "What I'd point at as evidence I understand it: §7 of the architecture doc lists thirteen
...
`ARCHITECTURE.md` §7** — thirteen defects, what each one taught. Counter-intuitive, but
